...
findBestPrediction <- function(Stock)
{
  ...
  plot(forecast(autofit1,h=24),xlim=c(2000,2015.2),lwd=2,col="red",xlab="Time",ylab="Stock price",main="Predictions of Polynomial Trend")
  ...
  plot(forecast(autofit2,h=24),xlim=c(2000,2015.2),lwd=2,col="blue",xlab="Time",ylab="Stock price",main="Predictions of STL Trend")
  lines(train,lw=3)
  ...
  plot(forecast(autofitr,h=24),xlim=c(2000,2015.2),lw=2,col="blue",xlab="Time",ylab="stock price",main="Predictions of Actual Trend")
  ...
  forecasts <- lapply(list(predfitr, predNETfitr, predHWStockr, predHWStockr_ng, predautofit2, predfit12, 
                           predfit2, predstlStock1, predstlStock2, predstlStockr, predNETfit2, predHWStock2, 
                           predHWStock2_ng, predautofit1, predfitlr , predfitl1, predfitl2, predNETfit1, 
                           predHWStock1_ng, predHWStock11, predHWStock12, predHWStock13), forecast, 12)
